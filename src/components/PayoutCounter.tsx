    ...
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="flex flex-col items-center">
          ...
          <div
            ref={ref}
            className="text-[100px] md:text-[220px] font-semibold bg-gradient-to-r from-purple-400 to-pink-400 text-transparent bg-clip-text"
          >
          ...
          <div className="flex justify-center items-center pt-4">
            <Button
              style={{
                backgroundColor:
                  "var(--token-fd5ec20b-d16d-421a-a635-4b3527184762, rgb(0, 0, 0))",
              }}
              className="py-4 px-8 text-md rounded-2xl shadow-lg hover:opacity-90 text-white min-w-[200px] min-h-[45px] flex items-center justify-center"
            >
